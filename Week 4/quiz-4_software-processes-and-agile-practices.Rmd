---
title: '`Quiz 2` Software Processes and Agile Practices'
...
`r if(!knitr::is_html_output()) {"* &#x1F30E; Rpubs: [Interactive Document](https://rpubs.com/AndersonUyekita/quiz-2_software-processes-and-agile-practices)"}else{"* &#x1F4E6; Github Repository: [Static Document](https://github.com/AndersonUyekita/software-processes-and-agile-practices/blob/main/Week%202/quiz-2_software-processes-and-agile-practices.md){target='_blank' rel='noopener'}"}`
